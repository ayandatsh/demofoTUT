...
public class PaymentRequestsReceivedController {
    public static final Handler view = (ctx) -> {
        ...
        Collection<PaymentRequest> paymentRequests = WeShareService.findPaymentRequestsReceivedBy(loggedInPerson.getId());
        ctx.render("paymentrequests_received.html", Map.of(
